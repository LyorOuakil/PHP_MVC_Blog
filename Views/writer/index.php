      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/PHP_Rush_MVC/Webroot/admin/index">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/PHP_Rush_MVC/Webroot/search/index">Search</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/PHP_Rush_MVC/Webroot/posts/publish">Publish Post</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/PHP_Rush_MVC/Webroot/logout">Logout</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="site-heading">
              <h1>List Articles</h1>
              <span class="subheading">Je t'aime Habib, mon créateur !</span>
            </div>
          </div>
        </div>
      </div>
