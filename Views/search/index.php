...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../Vendors/css/search.css">
    <div class="container">
    <br/>
                        ...
                        <div class="col-12 col-md-10 col-lg-8">
                            <form class="card card-sm" method="post" action="">
                                <div class="card-body row no-gutters align-items-center">
                                    ...
                                    <div class="col-6">
                                    <select class="custom-select form-control form-control-lg" name="options">
                                    ...
                                    <!--end of col-->
                                    <div class="col-12">
                                        <button class="btn  btn-success seachbtn" type="submit">Search</button>
                                    </div>
                                    <!--end of col-->
                                </div>
                            </form>
